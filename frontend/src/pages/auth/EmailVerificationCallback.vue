<template>
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    <div
      class="bg-white/70 backdrop-blur-xl py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-white/50 relative overflow-hidden"
    >
      <!-- Decorative background elements -->
      <div
        class="absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-farm-400/20 to-green-400/20 rounded-full blur-3xl pointer-events-none"
      ></div>
