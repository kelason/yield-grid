<template>
  <div class="bg-white">
    <!-- Hero -->
    <div
      class="relative bg-gradient-to-br from-earth-50 via-white to-farm-50 py-20 overflow-hidden"
    >
      <div
        class="absolute top-0 right-0 w-96 h-96 bg-farm-200/20 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"
        aria-hidden="true"
      ></div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <span
          class="inline-flex items-center gap-1.5 bg-farm-100 text-farm-700 text-xs font-semibold px-3 py-1.5 rounded-full border border-farm-200 mb-6"
        >
        ...
        <h1 class="text-5xl font-extrabold text-gray-900 tracking-tight mb-6">
          Empowering the<br />
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-farm-500 to-farm-700"
            >Modern Farmer</span
          >
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          ...
          :key="feature.title"
          class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-farm-200 transition-all duration-200"
        >
          <div
            class="w-12 h-12 rounded-xl bg-gradient-to-br from-farm-50 to-farm-100 flex items-center justify-center text-2xl mb-4 border border-farm-100"
          >
            {{ feature.icon }}
          </div>
