<template>
  <div class="confidence-meter w-24 h-24 relative">
    ...
    <div class="confidence-label absolute inset-0 flex items-center justify-center text-sm font-bold text-gray-800">
      {{ score }}%
    </div>
  </div>
</template>
...
const chartData = computed(() => {
  ...
  if (props.score < 50) color = '#EF4444'; // red for low
