<template>
  <div
    class="flex flex-col items-center justify-center p-8 bg-green-50 rounded-xl border border-green-200"
  >
    <div class="animate-pulse flex flex-col items-center">
      ...
      <p class="text-green-600 mt-2 text-sm text-center max-w-sm">
