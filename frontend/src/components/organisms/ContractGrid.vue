...
<template>
  <div>
    <!-- Loading State -->
    <div v-if="loading && contracts.length === 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="i in 6" :key="i" class="bg-white rounded-lg border border-gray-100 shadow-sm p-5 h-64 animate-pulse flex flex-col">
    ...
    <!-- Empty State -->
    <div v-else-if="contracts.length === 0" class="text-center py-16 bg-white rounded-lg border border-gray-100 border-dashed">
