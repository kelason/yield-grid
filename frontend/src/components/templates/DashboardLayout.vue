...
<template>
  <div class="h-screen flex overflow-hidden bg-gray-50 font-sans">
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden">
      <!-- Mobile header -->
      <div
        class="md:hidden pl-3 pt-3 pr-3 pb-2 flex justify-between items-center bg-white border-b border-gray-200 shadow-sm"
      >
      ...
      <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
        ...
        <div class="bg-gradient-to-r from-earth-50 to-white border-b border-gray-200">
          <div
            class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-5 flex justify-between items-center"
          >
            <div>
