...
<template>
  <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 p-5 hover:border-farm-300 transition-colors">
    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
      ...
      <!-- Payment Info -->
      <div class="flex flex-col items-start sm:items-end bg-gray-50 p-4 rounded-md sm:min-w-[200px]">
        <div class="text-xs text-gray-500 mb-1">Total Paid</div>
        <PriceTag :amount="purchase.amount_paid" :currency="purchase.currency" size="md" class="mb-2" />
